...
base_dir <- "experiments/GSE120561/kallisto/quant"
...
#ggsave(file="results/volcano1_queen_v03.jpeg", height=5, width=9, dpi=300)
```
...
volcano + geom_label_repel(data= legen, aes(label= legen$target_id), size=4, fontface = "italic",
  ...
  labs(title= "Volcano plot of Diferencial Expressed Transcipts",
       ...
       color="Differentially Expressed") +
  theme_bw() + coord_cartesian(clip = "off")
#ggsave(file="results/volcano2_queenless_v03.jpeg", height=5, width=9, dpi=300)
```
...
plot_grid(plot1 + theme(legend.position="right"),  
          ...
          labels = c("A", "B", "C", "D"),
          ncol = 1, nrow = 4)
#ggsave(file="results/boxplot5_all_v02.jpeg", height=16, width=10, dpi=300)
```
